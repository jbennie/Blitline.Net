...
namespace Blitline.Net.Request.Builders
{
    public class SaveBuilder : BuilderBase<Save>
    {
        ...
        //public SaveBuilder QuantizePng(int? quality = null)
        //{
        //    // check limit and if required set to limit. 5 is the default.         
        //    quality = (quality ?? 5) > 10 ? 10 : quality;
        //    quality = (quality ?? 5) < 1 ? 1 : quality; 

        //    _save.PngQuantize = quality;
        //    return this;
        //}


        public SaveBuilder QuantizePng(bool? yn = null)
        {
            _save.PngQuantize = yn;
            return this;
        }
